                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control" name="title_fa" id="title_fa" placeholder="*"
                                value="{{ old('title_fa') ?? $movie->title_fa }}" autocomplete="off">
                        </div>
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control" name="title_en" id="title_en" placeholder="*"
                                value="{{ old('title_en') ?? $movie->title_en }}" autocomplete="off">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="summary" class="form-label fw-bold">خلاصه:</label>
                        <textarea class="form-control" name="summary" id="summary" rows="6" placeholder="*" autocomplete="off" required>{{ old('summary') ?? $movie->summary }}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md-2">
                            ...
                            <input type="text" class="form-control" name="year" id="year" placeholder="*"
                                value="{{ old('year') ?? $movie->year }}" autocomplete="off">
                        </div>
                        <div class="col-12 col-md-3">
                            ...
                            <input type="text" class="form-control" name="country" id="country" placeholder="*"
                                value="{{ old('country') ?? $movie->country }}" autocomplete="off">
                        </div>
                        ...
                        <div class="col-12 col-md-2">
                            ...
                            <input type="text" class="form-control" name="imdb_rate" id="imdb_rate" placeholder="*"
                                value="{{ old('imdb_rate') ?? $movie->imdb_rate }}" autocomplete="off">
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <input type="text" class="form-control" name="director" id="director" placeholder="*"
                                value="{{ old('director') ?? $movie->director }}" autocomplete="off">
                        </div>
                        ...
                        <div class="col-12 col-md-7">
                            ...
                            <input type="text" class="form-control" name="actors" id="actors" placeholder="*"
                                value="{{ old('actors') ?? $movie->actors }}" autocomplete="off">
                        </div>
                        <div class="col-12 col-md-2">
                            ...
                            <select class="form-select" id="is_special" name="is_special">
                                @if ($movie->is_special == 1)
                                    <option value="{{ $movie->is_special == 1 }}">
                                        {{ $movie->is_special ? 'بله' : 'خیر' }}</option>
                    ...
                    <div class="row  mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input type="checkbox" name="has_subtitle" value="1"
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                ...
                                <input type="checkbox" name="has_dub" value="1"
                                    {{ old('has_dub', $movie->has_dub) ? 'checked' : '' }}>
                                <label class="form-check-label">
                                    دارای دوبله فارسی
                                </label>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="status" value="1"
                                {{ old('status', $movie->status ?? 0) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                نمایش در سایت
                            </label>
                        </div>
