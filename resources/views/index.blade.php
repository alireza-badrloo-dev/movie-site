    ...
    <div class="col-12 col-lg-8  ">
        <div class="card  shadow-sm  rounded rounded-2 border-0 p-3 ">
            <div class="text-center">
                <img src="\image\Artboard 1.svg" alt="" width="32px" height="32px">
            </div>
            <h6 class="text-center my-2">دانلود فیلم و سریال دوبله فارسی بدون سانسور با لینک مستقیم</h4>
                <small class="d-block text-center text-muted">
                    آرشیو کامل | کیفیت Full HD | لینک مستقیم
                </small>
        </div>
